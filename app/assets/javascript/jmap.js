...
(function($) {
  ...
  $.fn.jmap = function(options) {
      ...
      var params = $.extend({
          ...
          areas: [
            {code: 1,name: "北海道",number: 2},
            {code: 2,name: "青森",number: 1},
            {code: 3,name: "岩手",number: 0},
            {code: 4,name: "宮城",number: 7},
            {code: 5,name: "秋田",number: 0},
            {code: 6,name: "山形",number: 0},
            {code: 7,name: "福島",number: 5},
            {code: 8,name: "茨城",number: 0},
            {code: 9,name: "栃木",number: 0},
            {code: 10,name: "群馬",number: 0},
            {code: 11,name: "埼玉",number: 3},
            {code: 12,name: "千葉",number: 6},
            {code: 13,name: "東京",number: 5},
            {code: 14,name: "神奈川",number: 7},
            {code: 15,name: "新潟",number: 3},
            {code: 16,name: "富山",number: 5},
            {code: 17,name: "石川",number: 2},
            {code: 18,name: "福井",number: 1},
            {code: 19,name: "山梨",number: 7},
            {code: 20,name: "長野",number: 11},
            {code: 21,name: "岐阜",number: 0},
            {code: 22,name: "静岡",number: 2},
            {code: 23,name: "愛知",number: 8},
            {code: 24,name: "三重",number: 9},
            {code: 25,name: "滋賀",number: 1},
            {code: 26,name: "京都",number: 4},
            {code: 27,name: "大阪",number: 5},
            {code: 28,name: "兵庫",number: 9},
            {code: 29,name: "奈良",number: 2},
            {code: 30,name: "和歌山",number: 7},
            {code: 31,name: "鳥取",number: 9},
            {code: 32,name: "島根",number: 3},
            {code: 33,name: "岡山",number: 4},
            {code: 34,name: "広島",number: 7},
            {code: 35,name: "山口",number: 2},
            {code: 36,name: "徳島",number: 8},
            {code: 37,name: "香川",number: 8},
            {code: 38,name: "愛媛",number: 8},
            {code: 39,name: "高知",number: 2},
            {code: 40,name: "福岡",number: 4},
            {code: 41,name: "佐賀",number: 5},
            {code: 42,name: "長崎",number: 6},
            {code: 43,name: "熊本",number: 0},
            {code: 44,name: "大分",number: 8},
            {code: 45,name: "宮崎",number: 12},
            {code: 46,name: "鹿児島",number: 6},
            {code: 47,name: "沖縄",number: 3}
          ]
      }, options);
